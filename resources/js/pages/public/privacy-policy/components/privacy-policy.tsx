    ...
    return (
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <nav className="lg:col-span-1">
                <div className="sticky top-24 rounded-lg bg-card p-4 shadow-sm">
                ...
                <div className="rounded-lg border border-gray-200 bg-card p-8 shadow-sm">
                    ...
                    <section id="introduction" className="mb-12">
                        ...
                        <p className="mb-4 leading-relaxed">
                            Welcome to our MCQs Preparation Platform. We are
                        ...
                        <p className="leading-relaxed">
                            ...
                            terms outlined in this Privacy Policy. If you do not
                            agree with our practices, please do not use our
                            services.
                        </p>
                    </section>
                    ...
                    <section id="information" className="mb-12">
                        ...
                        <p className="mb-3 leading-relaxed">
                            When you register for an account or use our premium
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Practice test results and performance metrics
                            </li>
                            <li>
                                Questions attempted and time spent on platform
                            </li>
                            <li>
                                Custom paper preferences and categories selected
                            </li>
                            <li>
                                Progress tracking data and learning patterns
                            </li>
                        </ul>
                    ...
                    <section id="usage" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                To provide and maintain our MCQs preparation
                                services
                            </li>
                            <li>
                                To process premium subscription payments and
                                manage accounts
                            </li>
                            <li>
                                To track your progress and generate performance
                                analytics
                            </li>
                            <li>
                                To generate AI-powered practice papers based on
                                your preferences
                            </li>
                            <li>
                                To send notifications about new job postings and
                                practice materials
                            </li>
                            <li>
                    ...
                    <section id="protection" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                Restricted access to personal data by authorized
                                personnel only
                            </li>
                            <li>
                    ...
                    <section id="cookies" className="mb-12">
                        ...
                        <p className="mt-4 leading-relaxed">
                            ...
                            browser settings. Note that disabling certain
                    ...
                    <section id="rights" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                <strong>Data Portability:</strong> Receive your
                            ...
                            <li>
                                <strong>Restriction:</strong> Request limitation
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mt-4 leading-relaxed">
                            ...
                            and we encourage you to review them. We are not
                    ...
                    <section className="mb-12">
                        ...
                        <p className="leading-relaxed">
                            ...
                            legal obligations. When you delete your account, we
                            will remove your personal data within 30 days,
                            except where retention is required by law. Practice
                            history and performance data may be anonymized and
                    ...
                    <section className="mb-12">
                        ...
                        <p className="leading-relaxed">
                            Our services are intended for individuals aged 16
                            and above. We do not knowingly collect personal
                            information from children under 16. If you believe
                    ...
                    <section className="mb-12">
                        ...
                        <p className="leading-relaxed">
                            ...
                            changes via email or through a prominent notice on
                            our platform. Your continued use of our services
                            after such modifications constitutes acceptance of
                            the updated policy.
                        </p>
                    </section>
                    ...
                    <div className="border-t border-gray-200 pt-8">
                        <p className="text-center text-sm text-muted">
                            ...
                            Pakistan. By using our platform, you consent to the
                            collection and use of information as described in
                            this policy.
                        </p>
                    </div>
                </div>
