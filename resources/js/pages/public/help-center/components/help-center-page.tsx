...
const HelpCard: React.FC<{
    ...
    className?: string;
    iconClass?: string;
}> = ({ title, description, email, icon, className, iconClass }) => {
    return (
        <div
...
export function HelpCenterPage() {
    ...
    const faqs = [
        ...
        {
            question:
                'How can I practice MCQs for PPSC, FPSC, and other tests?',
    ...
    return (
        <div>
            {/* Category Pills */}
            <div className="my-6 flex flex-wrap justify-center gap-3 md:mb-8">
            ...
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
                            ...
                            >
                                {filteredFaqs.map((faq, index) => (
                                    ...
                                    >
                                        ...
                                        <AccordionContent>
                                            <p className="p-3 leading-relaxed md:p-6">
                                                {faq.answer}
                                            </p>
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <ol className="space-y-3">
                                        {guide.steps.map((step, stepIndex) => (
                                            ...
                                            >
                                                ...
                                                <span className="pt-0.5 max-md:text-sm">
                                                    {step}
                                                </span>
                                            </li>
                                        ))}
                    ...
                    <SectionLayout>
                        ...
                        <div className="space-y-6">
                            {premiumGuides.map((guide, index) => (
                                ...
                                >
                                    <h3 className="mb-3 font-semibold lg:text-xl">
                                        {guide.title}
                                    </h3>
                        ...
                        <div className="bg-info mt-6 rounded-lg p-4">
                            <p className="text-info-foreground text-sm">
                                <strong>💡 Pro Tip:</strong> Premium features
                                are designed to maximize your exam preparation.
                                Use custom papers to focus on weak areas and
                                track your progress regularly to see improvement
                                over time.
                            </p>
                        </div>
                    </SectionLayout>
                ...
                {activeCategory === 'jobs' && (
                    <SectionLayout>
                            ...
                            {jobsInfo.map((info, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        {info.isWarning && (
                                            <AlertCircle className="text-warning-foreground mt-0.5 h-5 w-5 flex-shrink-0" />
                                        )}
                        ...
                        <div className="bg-success mt-6 rounded-lg border border-green-200 p-4">
                            <div className="flex items-start gap-3">
                                <CheckCircle className="text-success-foreground mt-0.5 h-5 w-5 flex-shrink-0" />
                                <p className="text-success-foreground text-sm">
                                    Job ads are updated daily! Enable
                                    notifications in your account settings to
                                    receive alerts about new job postings
                        ...
                        <div className="space-y-6">
                            {billingInfo.map((info, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        {info.isWarning && (
                                            <AlertCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-destructive-foreground" />
                                        )}
                                        <div className="flex-1">
                                            <h3
                ...
                {activeCategory === 'support' && (
                    <SectionLayout>
                        ...
                        <div className="mt-8 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-green-50 p-6">
                            <h3 className="text-info-foreground mb-3 font-semibold md:text-lg">
                                Response Time
                            </h3>
                            <p className="leading-relaxed max-md:text-sm">
                                We typically respond to support emails within 24
                                hours during business days. For urgent issues,
                                please mark your email as "Urgent" in the
                                subject line. Premium members receive priority
                                support.
                            </p>
                        </div>
                    </SectionLayout>
