...
interface TestingServicePageProps extends SharedData {
...
const TestingServicePage = () => {
    ...
    } = usePage<TestingServicePageProps>().props;
    return (
        <AppLayout>
            <AppCenterHead />
            <TopAdSection />
            <MainSectionWithSidebarLayout>
                <div className="mb-6 grid items-center gap-4 lg:grid-cols-3 lg:gap-8">
                    <div className="lg:col-span-2">
                        <PageTitle title={testing_service.name} />
                        {/* <div className="flex justify-between">
                            <div className="flex items-center gap-2">
                                {testing_service.short_name && (
                        ...
                        <div className="flex items-center gap-2">
                            <p>{testing_service.description}</p>
                        </div>
                    </div>
                    <SearchBar />
                </div>
                ...
                <pre>{JSON.stringify(testing_service, null, 2)}</pre>
            </MainSectionWithSidebarLayout>
        </AppLayout>
    );
};
