...
const contactSchema = {
    ...
    '@type': 'ContactPage',
    name: 'Contact PAK QUIZ',
    url: 'https://www.pakquiz.com/contact-us',
    description:
        'Get in touch with the PAK QUIZ team for support, feedback, and inquiries about MCQs preparation, premium plans, or job updates.',
    mainEntity: {
        '@type': 'Organization',
        name: 'PAK QUIZ',
...
export function ContactPage() {
    ...
    return (
        <>
            {/* Main Content */}
            <div className="mt-6 grid gap-8 md:grid-cols-3 md:py-8">
                {/* Contact Information */}
                <div className="space-y-6 sm:col-span-1 order-2">
