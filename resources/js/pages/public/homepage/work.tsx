...
import HeroSection from '@/pages/public/homepage/components/HeroSection';
...
const Working = ({ mcqs }: Props) => {
    ...
    const [selectedTestService, setSelectedTestService] =
    ...
    const filteredMCQs = data.filter((mcq) => {
        const matchesSubject =
            ...
            mcq.subject === selectedSubject;
        const matchesJob =
            selectedJobType === 'All Jobs' ||
            mcq.tags.some((tag) =>
                tag
                    .toLowerCase()
                    .includes(selectedJobType.toLowerCase().split(' ')[0]),
            );
        const matchesService =
            selectedTestService === 'All Services' ||
            mcq.paper?.testing_service.short === selectedTestService;
    ...
    return (
        <>
            ...
            <section
                className="border-y px-4 py-6 sm:px-6 md:py-16 lg:px-8"
                ref={scrollRef}
            >
                        ...
                        <div className="lg:col-span-2">
                            <div className="mb-6 flex items-center justify-between">
                                <h3 className="text-xl font-semibold">
                                    MCQs ({filteredMCQs.length} found)
                                </h3>
