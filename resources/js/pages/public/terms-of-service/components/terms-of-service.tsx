    ...
    return (
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <nav className="lg:col-span-1">
                <div className="sticky top-22 z-50 rounded-lg bg-card p-4 shadow-sm">
                ...
                <div className="rounded-lg bg-card p-8 shadow-sm">
                    ...
                    <section id="acceptance" className="mb-12">
                        ...
                        <p className="mb-4 leading-relaxed">
                            Welcome to our MCQs Preparation Platform. By
                            ...
                            with any part of these terms, you may not use our
                            services.
                        </p>
                        <p className="mb-4 leading-relaxed">
                            These Terms constitute a legally binding agreement
                            between you and our platform. We reserve the right
                            to modify these Terms at any time. Your continued
                            use of the platform after changes are posted
                            constitutes acceptance of the modified Terms.
                        </p>
                        <div className="bg-info mt-4 rounded-lg border border-blue-200 p-4">
                            <p className="text-info-foreground text-sm">
                                <strong>Important:</strong> Please read these
                                Terms carefully before using our platform. By
                    ...
                    <section id="services" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Categorized MCQs bank covering various subjects
                            </li>
                            <li>Demo practice papers with sample questions</li>
                            <li>
                                Latest government and private sector job
                                listings
                            </li>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Custom paper creation with category and question
                                selection
                            </li>
                        ...
                        <p className="leading-relaxed">
                            ...
                            availability but do not guarantee uninterrupted
                            access. We reserve the right to modify, suspend, or
                            discontinue any aspect of our services at any time
                            without prior notice. We are not liable for any
                    ...
                    <section id="subscription" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Premium subscriptions are available on monthly
                                or annual basis
                            </li>
                            <li>
                            ...
                            <li>
                                Payment must be made through our authorized
                                payment methods
                            </li>
                            <li>
                                Subscriptions auto-renew unless cancelled before
                                renewal date
                            </li>
                            <li>
                                You will receive notification before each
                                renewal
                            </li>
                        </ul>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                All fees are non-refundable except as required
                                by law
                            </li>
                            <li>
                                We reserve the right to change subscription
                                prices with notice
                            </li>
                            <li>
                                Price changes do not affect current subscription
                                period
                            </li>
                            <li>
                            ...
                            <li>
                                All applicable taxes will be added to
                                subscription fees
                            </li>
                        </ul>
                        ...
                        <p className="mb-3 leading-relaxed">
                            ...
                            through your account settings. Upon cancellation:
                        </p>
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                You will retain access until the end of current
                                billing period
                            </li>
                            <li>
                            ...
                            <li>
                                Your account will revert to free tier after
                                expiration
                            </li>
                        </ul>

                        <div className="bg-warning mt-4 flex gap-3 rounded-lg border border-amber-200 p-4">
                            <AlertTriangle className="text-warning-foreground mt-0.5 h-5 w-5 flex-shrink-0" />
                            <p className="text-warning-foreground text-sm">
                                <strong>No Refund Policy:</strong> All
                                subscription fees are non-refundable. We do not
                                provide refunds or credits for partial
                                subscription periods, unused services, or if you
                    ...
                    <section id="conduct" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Copying, reproducing, or distributing our MCQs
                                or content
                            </li>
                            <li>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                Interfering with platform operation or other
                                users' access
                            </li>
                        </ul>
                        ...
                        <p className="leading-relaxed">
                            If you submit any content, feedback, or suggestions
                            to us, you grant us a perpetual, irrevocable,
                            worldwide, royalty-free license to use, modify, and
                            incorporate such content into our services without
                            compensation to you.
                        </p>
                    </section>
                    ...
                    <section id="intellectual" className="mb-12">
                        ...
                        <p className="mb-4 leading-relaxed">
                            ...
                            limited to MCQs, questions, answers, explanations,
                            practice papers, job listings, text, graphics,
                            logos, icons, images, audio clips, and software, is
                            the property of our platform or our content
                            suppliers and is protected by Pakistani and
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Access and use our platform for personal,
                                non-commercial purposes
                            </li>
                            <li>
                                View and practice with MCQs and materials
                                provided
                            </li>
                            <li>
                                Download content for offline personal study
                                (premium users only)
                            </li>
                        </ul>
                        <p className="mt-3 leading-relaxed">
                        ...
                        <p className="leading-relaxed">
                            Our platform name, logo, and related marks are
                            trademarks. You may not use these marks without our
                            prior written permission. All other trademarks
                            appearing on our platform are the property of their
                            respective owners.
                        </p>
                    </section>
                    ...
                    <section id="liability" className="mb-12">
                        ...
                        <p className="mb-4 leading-relaxed">
                            Our platform and services are provided on an "as is"
                            and "as available" basis without warranties of any
                            kind, either express or implied. We do not warrant
                            that:
                        </p>
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                The service will be uninterrupted, timely,
                                secure, or error-free
                            </li>
                            <li>
                                The results from using our service will be
                                accurate or reliable
                            </li>
                            <li>
                                The quality of products, services, or
                                information will meet expectations
                            </li>
                            <li>
                                Any errors in the software or content will be
                                corrected
                            </li>
                        </ul>
                        ...
                        <div className="mb-4 rounded-lg border border-red-200 bg-destructive/20 p-4">
                            <p className="leading-relaxed text-destructive-foreground">
                                <strong>Important:</strong> While we strive to
                                provide accurate and up-to-date MCQs and
                                practice materials, we do not guarantee the
                                accuracy, completeness, or reliability of any
                                content. Our platform is for practice and
                                preparation purposes only. We are not
                                responsible for:
                            </p>
                            <ul className="mt-2 ml-4 list-inside list-disc space-y-1 text-destructive-foreground">
                                ...
                                <li>
                                    Errors or omissions in MCQs or explanations
                                </li>
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                Any damages arising from your use or inability
                                to use our services
                            </li>
                        </ul>
                        <p className="mt-3 leading-relaxed">
                            Our total liability shall not exceed the amount you
                            paid for premium services in the 12 months preceding
                            the claim.
                        </p>
                        ...
                        <p className="leading-relaxed">
                            Job listings and information about government exams
                            are provided for informational purposes only. We do
                            not verify the accuracy of job postings and are not
                            responsible for third-party content, websites, or
                    ...
                    <section id="termination" className="mb-12">
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                Accessing account settings and selecting account
                                deletion
                            </li>
                            <li>Contacting our support team</li>
                        </ul>
                        <p className="mt-3 leading-relaxed">
                            Upon termination, you will lose access to all
                            services, including saved progress and premium
                            features. No refunds will be provided for any
                        ...
                        <p className="mb-3 leading-relaxed">
                            ...
                            account immediately, without prior notice, if:
                        </p>
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            ...
                            <li>
                                We suspect unauthorized access or security
                                breaches
                            </li>
                        ...
                        <p className="leading-relaxed">
                            Upon termination of your account, all licenses
                            granted to you will immediately cease, and you must
                            discontinue all use of our services. We may retain
                            your information as required by law or for
                            legitimate business purposes. Sections of these
                            Terms that by their nature should survive
                            termination shall survive, including intellectual
                            property provisions, disclaimers, and limitations of
                            liability.
                        </p>
                    </section>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mb-4 leading-relaxed">
                            ...
                            accordance with the laws of Pakistan, without regard
                        ...
                        <ul className="ml-4 list-inside list-disc space-y-2">
                            <li>
                                You agree to first attempt to resolve the
                            ...
                            <li>
                                Both parties agree to waive any right to a jury
                                trial
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="leading-relaxed">
                            ...
                            our platform, its officers, directors, employees,
                            and agents from and against any claims, liabilities,
                            damages, losses, and expenses arising out of or in
                            any way connected with your access to or use of our
                            services, your violation of these Terms, or your
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mt-4 leading-relaxed">
                            ...
                            Terms. If you do not agree to the modified Terms,
                    ...
                    <section className="mb-12">
                        ...
                        <p className="leading-relaxed">
                            ...
                            any other legal notices published by us on our
                            platform, constitute the entire agreement between
                            you and us concerning your use of our services and
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-info rounded-lg p-6">
