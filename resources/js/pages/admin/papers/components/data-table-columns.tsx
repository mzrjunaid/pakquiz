...
import { ArrowUpDown, FileText, MoreHorizontal, Pencil } from 'lucide-react';
...
export const getColumns = ({
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <TextLink href={papers.show(row.original.slug)}>
                {row.getValue('name')}
            </TextLink>
        ),
    },
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                testing_service && (
                    <TextLink
                        href={testingServices.show(testing_service?.slug)}
                    >
