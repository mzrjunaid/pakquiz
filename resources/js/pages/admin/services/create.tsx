...
export default function TestingServiceCreate({
    availableTags,
    ...
    const form = useForm<{
        ...
        seo_og_image_url: '',
        seo_og_image: null, // Changed from '' to null to match the type
    });
    ...
    return (
        <AdminLayout title={`Create Testing Service`}>
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Create a new testing service to be used on the admin
                            and public side.
                        </p>
                    </div>
                        ...
                        <FieldGroup className="gap-5">
                            <Field>
                                ...
                                <Input
                                    ...
                                    placeholder="Enter testing service name"
                                />
                            ...
                            <div className="grid gap-5 md:grid-cols-2">
                                ...
                                <Field>
                                    ...
                                    <Input
                                        ...
                                        placeholder="Short name for this testing service"
                                    />
                                    <InputError
