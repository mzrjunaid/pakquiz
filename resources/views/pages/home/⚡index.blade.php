...
<div>
    <div class="max-w-7xl mx-auto px-4 lg:px-0 py-6 md:py-12">
        ...
        <section class="flex flex-col gap-6 md:flex-row px-4 py-6 md:py-12 md:px-0">
            <div class="space-y-4 w-full md:w-2/3">
                ...
                <p class="text-xs md:text-base text-justify">Welcome to PakQuiz, your premier destination for high-quality online MCQ preparation designed specifically for competitive exam aspirants. Whether you are preparing for the PPSC, FPSC, NTS, or CSS, our platform provides a sophisticated environment to master General Knowledge, Current Affairs 2026, and subject-specific topics. We meticulously curate our database using past paper MCQs and the latest exam patterns to ensure you are practicing with the most relevant material. At PakQuiz, we bridge the gap between study and success by offering intelligent practice sets that reflect the reality of modern testing, helping you build the confidence needed to excel in your professional career.</p>
            </div>
            ...
            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
                <div class="lg:col-span-2">
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <div class="flex justify-center">
                            <a href="{{ route('public.mcqs.index') }}" class="w-full py-2 text-center rounded-lg bg-primary hover:bg-primary/80 text-primary-foreground transition-all">
                                View All MCQs
                            </a>
                        </div>
                    </div>
                ...
                <aside class="flex flex-col gap-4">
                    <div class="rounded-lg bg-card p-6 shadow-md">
                        ...
                        <p class="mb-3 text-muted text-sm">Explore the latest papers for FPSC, PPSC, NTS, CSS, PMS and other competitive exams in Pakistan.</p>
                        <div class="md:px-2">
                    ...
                    <div class="rounded-lg bg-card p-6 shadow-md">
                        ...
                        <p class="mb-3 text-muted text-sm">Explore the latest subjects for FPSC, PPSC, NTS, CSS, PMS and other competitive exams in Pakistan.</p>
                        <div class="md:px-2">
                            ...
                            <div
                                ...
                                <x-heroicon-s-chevron-right class="h-5 w-5" />
                                <a
                                    href="{{ route('public.subject.show', $subject['slug']) }}"
                                    class="my-2 block">
                                    {{ $subject['name'] }}
                                </a>
                            </div>
                    ...
                    <div class="rounded-lg bg-card p-6 shadow-md">
                        ...
                        <p class="mb-3 text-muted text-sm">Explore the latest current affairs for FPSC, PPSC, NTS, CSS, PMS and other competitive exams in Pakistan.</p>
                        <div class="md:px-2">
                            ...
                            <div
                                ...
                                <x-heroicon-s-chevron-right class="h-5 w-5" />
                                <a
                                    href="{{ route('public.subject.show', ['subject' => $data['current_affairs']['slug'], 'topic' => $topic['slug']]) }}"
                                    class="my-2 block">
                                    {{ $topic['name'] }}
                                </a>
                            </div>
                    ...
                    <div class="rounded-lg bg-card p-6 shadow-md">
                        ...
                        <p class="mb-3 text-muted text-sm">Explore the latest departments for FPSC, PPSC, NTS, CSS, PMS and other competitive exams in Pakistan.</p>
                        <div class="md:px-2">
                            ...
                            <div
                                ...
                                <x-heroicon-s-chevron-right class="h-5 w-5" />
                                <a
                                    href="{{ route('public.departments.show', $dept['slug']) }}"
    ...
    <section class="bg-accent px-4 py-16 text-accent-foreground sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
            ...
            <p class="mb-8 text-lg md:text-xl">Join thousands of students who have improved their scores with our AI-powered MCQ platform</p>
