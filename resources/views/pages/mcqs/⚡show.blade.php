        ...
        <section x-data="{
            ...
            <div class="lg:col-span-2 space-y-6 md:space-y-12 overflow-hidden">
                ...
                <section class="mt-6 space-y-2 md:mt-12 md:space-y-4">
                    ...
                    <p class="text-xs md:text-base text-justify">
                        {!! str('Related MCQs where subject and topic are same as this mcq')->markdown() !!}
                    </p>
                    <div class="space-y-4">
            ...
            <div class="rounded-lg bg-card p-6 shadow-md">
                ...
                <div class="md:px-2">
                    ...
                    @foreach ($suggestedMcqs as $suggestedMcq)
                        <x-aside.link :route="'public.mcqs.show'" :label="$suggestedMcq->question"
                            :params="$suggestedMcq->slug" />
                    @endforeach
