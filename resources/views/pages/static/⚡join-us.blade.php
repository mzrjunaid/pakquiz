...
@push('meta')
<meta name="title" content="Join PakQuiz – Be Part of Pakistan's Exam Revolution">
<meta name="description" content="Join PakQuiz as a content contributor, MCQ writer, or team member. Help thousands of Pakistani students prepare for FPSC, PPSC, NTS, CSS & PMS exams.">
<meta name="robots" content="index, follow">
<link rel="canonical" href="{{ url('/join-us') }}">
...
<div class="join-page min-h-screen bg-gray-50">
    ...
    <section class="relative overflow-hidden bg-gray-950 text-white">
        ...
        <div class="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
            <div class="mx-auto max-w-3xl text-center">
                <div class="fade-up fade-up-1 mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-sm">
                ...
                <h1 class="display-font fade-up fade-up-2 mb-6 text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
                    Build Pakistan's<br>
                    <span class="bg-gradient-to-r from-blue-400 via-cyan-300 to-emerald-400 bg-clip-text text-transparent">
                        #1 Exam Platform
                    </span>
                    <br>with Us
                </h1>
    ...
    <section class="relative z-10 -mt-1 bg-white border-b border-gray-100 shadow-sm">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 divide-x divide-gray-100 md:grid-cols-4">
                ...
                ['number' => '10K+', 'label' => 'MCQs in Database'],
                ['number' => '15+', 'label' => 'Exam Categories'],
                ['number' => '2024', 'label' => 'Founded'],
                ] as $stat)
                <div class="py-6 text-center px-4">
                    <div class="stat-number text-3xl font-extrabold sm:text-4xl">{{ $stat['number'] }}</div>
                    <div class="mt-1 text-xs font-medium uppercase tracking-wider text-gray-500">{{ $stat['label'] }}</div>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-12 text-center">
            ...
            <p class="mx-auto max-w-xl text-gray-500">We're not just building an app. We're changing how Pakistan prepares.</p>
        </div>
    ...
    <section id="roles" class="stripe-bg border-y border-gray-100 bg-gray-50 py-16 lg:py-20">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <div class="mb-12 text-center">
                ...
                <p class="mx-auto max-w-xl text-gray-500">Pick the role that fits you best. Multiple roles? Apply for all.</p>
            </div>
                ...
                <div class="role-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div class="mb-4 flex items-start justify-between gap-3">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl {{ $role['iconBg'] }}">
    ...
    <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="space-y-6">
            @foreach ([
            ['step' => '01', 'color' => 'bg-blue-600', 'title' => 'Fill the Application', 'desc' => 'Tell us about yourself, your skills, and which role excites you. Takes under 3 minutes.'],
            ['step' => '02', 'color' => 'bg-emerald-600', 'title' => 'Quick Review', 'desc' => "Our team reviews your application and gets back to you within 48 hours. We read every single one."],
            ['step' => '03', 'color' => 'bg-violet-600', 'title' => 'Onboard & Contribute', 'desc' => "You'll get access to our contributor resources, style guides, and a warm welcome from the team."],
            ] as $i => $s)
            <div class="relative flex gap-5">
                @if (!$loop->last)
                <div class="step-connector"></div>
                @endif
                <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full {{ $s['color']}} text-sm font-bold text-white shadow-md">
                    {{ $s['step'] }}
                </div>
    ...
    <section id="apply" class="border-t border-gray-100 bg-white py-16 lg:py-20">
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-emerald-200 bg-emerald-50 p-8 text-center">
                ...
                <p class="text-emerald-700">Thank you for applying. We'll review your application and get back to you within 48 hours.</p>
            </div>
            @else
            <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                <div class="space-y-5">
                    ...
                    {{-- Role --}}
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-gray-700">Role You're Applying For *</label>
                    ...
                    {{-- Experience --}}
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-gray-700">Relevant Experience / Skills *</label>
                    ...
                    {{-- Motivation --}}
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-gray-700">Why do you want to join PakQuiz? *</label>
                        ...
                        @error('motivation')<p class="mt-1 text-xs text-red-500">{{ $message }}</p>@enderror
                    </div>

                    {{-- Portfolio --}}
                    <div>
                        <label class="mb-1.5 block text-sm font-semibold text-gray-700">Portfolio / LinkedIn / GitHub <span class="font-normal text-gray-400">(optional)</span></label>
                    ...
                    <div class="pt-2">
                        ...
                        <p class="mt-3 text-center text-xs text-gray-400">* Required fields &nbsp;·&nbsp; We respond within 48 hours</p>
                    </div>
