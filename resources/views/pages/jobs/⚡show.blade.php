                ...
                <article class="space-y-6">
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl p-6">
                        <h2 class="text-base font-medium text-gray-900 flex items-center gap-2 mb-4">
                            <span
                                class="w-7 h-7 rounded-lg bg-primary/10 flex items-center justify-center text-sm">📋</span>
                            Key Job Details
                        </h2>
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl p-6">
                        <h2 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-4">
                            <span
                                class="w-7 h-7 rounded-lg bg-blue-50 flex items-center justify-center text-sm">📋</span>
                            Description
                        </h2>
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl p-6">
                        <h2 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-4">
                            <span
                                class="w-7 h-7 rounded-lg bg-amber-50 flex items-center justify-center text-sm">🚀</span>
                            How to Apply
                        </h2>
                        <div class="space-y-4">
