...
<div class="rounded-lg bg-card p-4 md:p-6 shadow-md relative mb-2">
    ...
    <h2 class="mb-2 text-lg font-semibold">🚀 Found an error or have a suggestion?</h2>
    ...
    <form wire:submit="submit" class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
            ...
            <input id="name" wire:model="name" type="text" placeholder="Your Full Name..."
        ...
        <div class="flex flex-col gap-2">
            ...
            <input id="email" wire:model="email" type="text" placeholder="Your Email Address..."
                class="w-full px-3 py-2 text-foreground border border-gray-400 rounded-md shadow-sm focus:outline-none focus:border-primary hover:border-primary" />
        ...
        <div class="flex flex-col gap-2">
            ...
            <textarea id="suggested_content" wire:model="suggested_content" rows="3" placeholder="Your Suggestion..."
                class="w-full px-3 py-2 text-foreground border border-gray-400 rounded-md shadow-sm focus:outline-none focus:border-primary hover:border-primary"></textarea>
            @error('suggested_content')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        </div>
