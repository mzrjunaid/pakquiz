...
<div class="group rounded-md bg-card p-4 shadow-sm transition-all hover:shadow-md md:p-6">
    <a href="{{ route('public.departments.show', $department->slug) }}" class="block space-y-2">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center shrink-0 gap-2">
                <span class="text-sm text-muted mt-1">{{ $department->papers_count }} Papers</span>
    ...
    <div class="flex flex-wrap gap-2 mt-4">
        ...
        @foreach ($department->papers->take(3) as $paper)
