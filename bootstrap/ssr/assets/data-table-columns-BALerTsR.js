...
const getColumns = ({
  ...
  },
  {
    ...
    cell: ({ row }) => /* @__PURE__ */ jsx(TextLink, { href: testingServices.show(row.original.slug), children: row.getValue("name") })
  },
  {
    accessorKey: "topics",
    header: "Topics",
    cell: ({ row }) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: "whitespace-normal", children: topics.map((topic, index) => /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(TextLink, { href: `slug: ${topic.slug}`, children: topic.name }, index),
        ",",
        " "
      ] })) });
    }
