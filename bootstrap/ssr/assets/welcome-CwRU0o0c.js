...
import HeroSection from "./HeroSection-t2fE4hga.js";
...
function Welcome({
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsx(HeroSection, { mcq: heroSectionMcqs.data, stats }),
    /* @__PURE__ */ jsx("section", { className: "border-y px-4 py-6 sm:px-6 md:py-16 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8 flex flex-col items-start justify-between gap-y-6 lg:flex-row lg:items-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex w-full flex-row items-center md:max-w-sm", children: /* @__PURE__ */ jsx(SearchBar, { className: "w-full" }) })
      ] }),
        ...
        /* @__PURE__ */ jsxs(PageSidebar, { children: [
          /* @__PURE__ */ jsx(
            FeatureCard,
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "md:px-2", children: latestPapers.map((paper, idx) => /* @__PURE__ */ jsxs(
                "div",
                {
          ...
          /* @__PURE__ */ jsx(
            FeatureCard,
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "md:px-2", children: subjects_list.map((subject, idx) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "flex items-center gap-1 text-sm",
                  children: [
          ...
          /* @__PURE__ */ jsx(
            FeatureCard,
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "md:px-2", children: departments_list.map((dept, idx) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "flex items-center gap-1 text-sm",
                  children: [
