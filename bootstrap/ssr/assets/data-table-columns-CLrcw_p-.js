...
const getColumns = ({
  ...
  },
  {
    ...
    cell: ({ row }) => /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800", children: row.getValue("short_name") })
  },
  {
