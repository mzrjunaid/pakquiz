...
function McqsImportCopy() {
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { title: "MCQs Import", children: /* @__PURE__ */ jsx("div", { className: "w-full mx-auto py-10 space-y-6", children: /* @__PURE__ */ jsx(Card, { className: "rounded-2xl shadow", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-3 md:p-6 space-y-6", children: [
    ...
    errors.json && /* @__PURE__ */ jsx("p", { className: "text-sm text-red-500", children: errors.json }),
    preview && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600", children: [
        "Total MCQs: ",
        preview.length
      ] }),
      /* @__PURE__ */ jsx("div", { className: "overflow-y-auto border rounded-lg p-4 space-y-4", children: preview.slice(0, 5).map((mcq, index) => /* @__PURE__ */ jsxs("div", { className: "border-b pb-3", children: [
