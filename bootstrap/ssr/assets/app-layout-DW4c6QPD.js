...
create_copy.url = (options) => {
  return create_copy.definition.url + queryParams(options);
};
create_copy.get = (options) => ({
  url: create_copy.url(options),
  method: "get"
});
create_copy.head = (options) => ({
  url: create_copy.url(options),
  method: "head"
});
const create_copyForm = (options) => ({
  action: create_copy.url(options),
  method: "get"
});
create_copyForm.get = (options) => ({
  action: create_copy.url(options),
  method: "get"
});
create_copyForm.head = (options) => ({
