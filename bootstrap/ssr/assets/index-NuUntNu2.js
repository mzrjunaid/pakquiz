...
edit.url = (args, options) => {
  ...
  return edit.definition.url.replace("{subject}", parsedArgs.subject.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update.url = (args, options) => {
  ...
  return update.definition.url.replace("{subject}", parsedArgs.subject.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy.url = (args, options) => {
  ...
  return destroy.definition.url.replace("{subject}", parsedArgs.subject.toString()).replace(/\/+$/, "") + queryParams(options);
};
