...
function TestingServicesCreate() {
  return /* @__PURE__ */ jsx(AdminLayout, { title: "Testing Services Create", children: /* @__PURE__ */ jsx("h2", { children: "Testing Service Create" }) });
}
export {
  TestingServicesCreate as default
};
