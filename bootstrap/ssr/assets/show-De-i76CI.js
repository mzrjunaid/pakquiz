...
const SubjectPage = () => {
  const { seo, mcqs: mcqs$1, subject, schema } = usePage().props;
  const buildMcqLink = (slug) => mcqs.show({
    mcq: slug
  });
      ...
      /* @__PURE__ */ jsxs(PageSidebar, { children: [
        ...
        subject.topics && subject.topics.length > 1 && /* @__PURE__ */ jsx(
          FeatureCard,
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "md:px-2", children: subject.topics?.map((topic, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
