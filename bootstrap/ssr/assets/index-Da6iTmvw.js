...
show.url = (args, options) => {
  ...
  return show.definition.url.replace("{testing_service}", parsedArgs.testing_service.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit.url = (args, options) => {
  ...
  return edit.definition.url.replace("{testing_service}", parsedArgs.testing_service.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update.url = (args, options) => {
  ...
  return update.definition.url.replace("{testing_service}", parsedArgs.testing_service.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy.url = (args, options) => {
  ...
  return destroy.definition.url.replace("{testing_service}", parsedArgs.testing_service.toString()).replace(/\/+$/, "") + queryParams(options);
};
