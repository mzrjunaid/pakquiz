...
function TestingServicesShow() {
  return /* @__PURE__ */ jsx(AdminLayout, { title: "Testing Services Show", children: /* @__PURE__ */ jsx("h2", { children: "Testing Service Show" }) });
}
export {
  TestingServicesShow as default
};
