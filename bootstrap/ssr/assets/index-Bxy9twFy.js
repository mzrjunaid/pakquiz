...
import { P as PageTitle } from "./public-page-title-DXbFRyop.js";
    ...
    /* @__PURE__ */ jsx(MainSectionWithSidebarLayout, { children: /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-3 lg:gap-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4 md:space-y-6", children: [
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4 md:gap-6", children: subjects.map((subject) => /* @__PURE__ */ jsxs(
            "div",
            {
                  ...
                  Link,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                        /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-foreground transition-colors group-hover:text-primary md:text-xl", children: subject.name }),
                      ...
                      /* @__PURE__ */ jsx("p", { className: "line-clamp-2 text-sm text-foreground md:text-base", children: subject.description })
                    ]
                  }
                ),
                subject.topics && subject.topics.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-4 flex flex-wrap gap-2", children: subject.topics.map(
                  (topic) => /* @__PURE__ */ jsx(
                    Link,
                    {
                      ...
                      children: /* @__PURE__ */ jsx(Badge, { className: "cursor-pointer transition-colors hover:bg-primary/25 hover:text-primary", children: topic.name })
                    },
                    topic.id
                  )
                ) }),
                subject.updated_at && /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center gap-1.5 border-t border-gray-100 pt-3 text-xs text-gray-500 md:text-sm", children: [
                  /* @__PURE__ */ jsx(
                    "svg",
                    {
                      className: "h-4 w-4",
