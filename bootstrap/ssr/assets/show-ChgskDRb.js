...
const PaperPage = () => {
  const { paper, mcqs, schema, seo } = usePage().props;
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-6 grid items-center gap-4 lg:grid-cols-3 lg:gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsx(Badge, { variant: "outline", children: paper.department.name }),
            /* @__PURE__ */ jsx(Badge, { variant: "outline", children: paper.testing_service.short })
          ] })
        ] }),
