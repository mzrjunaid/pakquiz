...
function SearchBar({ className }) {
  ...
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(SearchBarClient, { className }) });
}
function SearchBarClient({
  ...
  return /* @__PURE__ */ jsxs("div", { ref: dropdownRef, className: `relative ${className}`, children: [
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute right-2 flex items-center gap-1", children: [
            ...
            searchTerm && !isLoading && /* @__PURE__ */ jsx(
              Button,
              {
                type: "button",
                variant: "ghost",
    ...
    isFocused && /* @__PURE__ */ jsxs("div", { className: "absolute z-50 mt-2 w-full rounded-xl bg-white shadow-xl", children: [
      ...
      searchTerm && /* @__PURE__ */ jsx("div", { className: "max-h-96 overflow-y-auto p-2", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "py-8 text-center", children: /* @__PURE__ */ jsx(Loader2, { className: "mx-auto animate-spin" }) }) : suggestions.length ? suggestions.map((item) => /* @__PURE__ */ jsxs(
        "a",
        {
          href: item.link,
