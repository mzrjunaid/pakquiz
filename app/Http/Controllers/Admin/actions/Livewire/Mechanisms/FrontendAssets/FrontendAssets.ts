...
* @route '/livewire-699ff768/livewire.min.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-699ff768/livewire.min.js',
...
* @route '/livewire-699ff768/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-699ff768/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-699ff768/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-699ff768/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
